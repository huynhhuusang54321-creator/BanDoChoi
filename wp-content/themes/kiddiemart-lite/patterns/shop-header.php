			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group alignwide has-foreground-color has-text-color">
						...
						<!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|meta"}}},"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"0"},"margin":{"top":"0","bottom":"0"}}},"textColor":"meta","fontSize":"upper-heading"} -->
						<p class="has-text-align-center has-meta-color has-text-color has-link-color has-upper-heading-font-size" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-bottom:0"><?php esc_html_e('Discover a joyful collection of toys, stylish clothes, and everyday essentials designed to keep your little ones happy, comfortable, and full of fun.', 'kiddiemart-lite'); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
