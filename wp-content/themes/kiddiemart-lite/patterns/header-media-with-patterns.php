		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile">
				<div class="wp-block-media-text__content">
					...
					<!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|40"}}}} -->
					<h2 class="wp-block-heading has-text-align-left" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--40)"><?php esc_html_e('A Fun Kids Play Everyday', 'kiddiemart-lite'); ?></h2>
					<!-- /wp:heading -->
