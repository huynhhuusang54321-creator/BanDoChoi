...
**Version 1.1.23** - 21/05/2026:
- [Bảo mật] Ngăn xử lý trùng lặp đơn hàng khi webhook bị retry
- [Bảo mật] Cải thiện bảo mật và độ ổn định

**Version 1.1.22** - 18/05/2026:
- [Fix lỗi] Sửa lỗi "Bạn không có quyền thực hiện hành động này" khi tải danh sách tài khoản ảo (sub-account) trong popup thiết lập webhook
